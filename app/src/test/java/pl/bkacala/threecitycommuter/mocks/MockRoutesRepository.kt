...
object MockRoutesRepository {
    val mockRoutesRepository = object : RoutesRepository {
        // Implementacja mockowych metod z interfejsu RoutesRepository
        override fun getRoute(
            routeId: Int,
            tripId: Int
        ): Flow<Route> {
            val mockPoints = listOf(
                Route.GeoPoint(54.372158, 18.638306),  // Gdańsk Główny
                Route.GeoPoint(54.351959, 18.648064)   // Gdańsk Wrzeszcz
            )
