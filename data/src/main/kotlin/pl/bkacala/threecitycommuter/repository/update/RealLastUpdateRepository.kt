...
class RealLastUpdateRepository @Inject constructor(private val sharedPreferences: SharedPreferences) : LastUpdateRepository {
    ...
    override fun storeLastUpdateCurrentTimeStamp(key: String) {
        sharedPreferences.edit().putLong("$LAST_UPDATE_KEY$key", Clock.System.now().epochSeconds).apply()
    }
